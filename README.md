...
- `PROMPTS.md`: Contains the complete, exact system instructions and few-shot prompt templates used to orchestrate the Large Language Model (`Meta-Llama-3.1-8B-Instruct`). This includes:
  - The Query Classifier (Intent Router) prompt.
  - The strict grounding generation prompt for the Query-Aware policy system.
  - The generation prompt for the General Knowledge system.
  - The unified instruction prompt for the baseline evaluations.
